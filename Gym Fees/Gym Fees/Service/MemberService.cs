...
namespace Gym_Fees.Service
{
    public class MemberService : IMemberService
    {
        ...
        public async Task<bool> RemoveUser(Guid MemberId)
        {
        ...
        public async Task<string> UpdateUser(MemberRequestDTO user, Guid id)
        {
            if (user != null)
            {
        ...
        public Task<bool> UpdateMember(MemberRequestDTO memberDto, Guid MemberId)
        {
            throw new NotImplementedException();
        }

        public Task<Member> AuthenticateAsync(string username, string password)
        {
            throw new NotImplementedException();
        }
    }
