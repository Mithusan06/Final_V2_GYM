...
namespace Gym_Fees.Controllers
{
    ...
    public class NotificationController : ControllerBase
    {
        ...
        public IActionResult DeleteNotification(Guid notificationId)
        {
            try
            {
                var data = _notificationServices.DeleteNotification(notificationId);
                return Ok(data);
            }
            catch (Exception ex)
            {
        ...
        [HttpPut]
        public IActionResult UpdateNotification(NotificationRequestDTO notificationRequest, Guid notificationId)
        {
            try
            {
                var Data = _notificationServices.UpdateNotification(notificationRequest, notificationId);
                return Ok(Data);
